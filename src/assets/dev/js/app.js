...
(function ($) {
  ...
  var waypointsInit = function waypointsInit() {
    ...
    }).wrap("<div class='title  title--has-tail  js-waypoint'></div>").addClass("title__highlight"); // Potential Refactor: in an ideal world, using Intersection Observer might be better for this
