...
*/
function(){var e=0,i={};function t(o){if(!o)throw new Error("No options passed to Waypoint constructor");if(!o.element)throw new Error("No element option passed to Waypoint constructor");if(!o.handler)throw new Error("No handler option passed to Waypoint constructor");this.key="waypoint-"+e,this.options=t.Adapter.extend({},t.defaults,o),this.element=this.options.element,this.adapter=new t.Adapter(this.element),this.callback=o.handler,this.axis=this.options.horizontal?"horizontal":"vertical",this.enabled=this.options.enabled,this.triggerPoint=null,this.group=t.Group.findOrCreate({name:this.options.group,axis:this.axis}),this.context=t.Context.findOrCreateByElement(this.options.context),t.offsetAliases[this.options.offset]&&(this.options.offset=t.offsetAliases[this.options.offset]),this.group.add(this),this.context.add(this),i[this.key]=this,e+=1}t.prototype.queueTrigger=function(e){this.group.queueTrigger(this,e)},t.prototype.trigger=function(e){this.enabled&&this.callback&&this.callback.apply(this,e)},t.prototype.destroy=function(){this.context.remove(this),this.group.remove(this),delete i[this.key]},t.prototype.disable=function(){return this.enabled=!1,this},t.prototype.enable=function(){return this.context.refresh(),this.enabled=!0,this},t.prototype.next=function(){return this.group.next(this)},t.prototype.previous=function(){return this.group.previous(this)},t.invokeAll=function(e){var t=[];for(var o in i)t.push(i[o]);for(var s=0,n=t.length;s<n;s++)t[s][e]()},t.destroyAll=function(){t.invokeAll("destroy")},t.disableAll=function(){t.invokeAll("disable")},t.enableAll=function(){for(var e in t.Context.refreshAll(),i)i[e].enabled=!0;return this},t.refreshAll=function(){t.Context.refreshAll()},t.viewportHeight=function(){return window.innerHeight||document.documentElement.clientHeight},t.viewportWidth=function(){return document.documentElement.clientWidth},t.adapters=[],t.defaults={context:window,continuous:!0,enabled:!0,group:"default",horizontal:!1,offset:0},t.offsetAliases={"bottom-in-view":function(){return this.context.innerHeight()-this.adapter.outerHeight()},"right-in-view":function(){return this.context.innerWidth()-this.adapter.outerWidth()}},window.Waypoint=t}(),function(){function e(e){window.setTimeout(e,1e3/60)}var i=0,t={},o=window.Waypoint,s=window.onload;function n(e){this.element=e,this.Adapter=o.Adapter,this.adapter=new this.Adapter(e),this.key="waypoint-context-"+i,this.didScroll=!1,this.didResize=!1,this.oldScroll={x:this.adapter.scrollLeft(),y:this.adapter.scrollTop()},this.waypoints={vertical:{},horizontal:{}},e.waypointContextKey=this.key,t[e.waypointContextKey]=this,i+=1,o.windowContext||(o.windowContext=!0,o.windowContext=new n(window)),this.createThrottledScrollHandler(),this.createThrottledResizeHandler()}n.prototype.add=function(e){var i=e.options.horizontal?"horizontal":"vertical";this.waypoints[i][e.key]=e,this.refresh()},n.prototype.checkEmpty=function(){var e=this.Adapter.isEmptyObject(this.waypoints.horizontal),i=this.Adapter.isEmptyObject(this.waypoints.vertical),o=this.element==this.element.window;e&&i&&!o&&(this.adapter.off(".waypoints"),delete t[this.key])},n.prototype.createThrottledResizeHandler=function(){var e=this;function i(){e.handleResize(),e.didResize=!1}this.adapter.on("resize.waypoints",(function(){e.didResize||(e.didResize=!0,o.requestAnimationFrame(i))}))},n.prototype.createThrottledScrollHandler=function(){var e=this;function i(){e.handleScroll(),e.didScroll=!1}this.adapter.on("scroll.waypoints",(function(){e.didScroll&&!o.isTouch||(e.didScroll=!0,o.requestAnimationFrame(i))}))},n.prototype.handleResize=function(){o.Context.refreshAll()},n.prototype.handleScroll=function(){var e={},i={horizontal:{newScroll:this.adapter.scrollLeft(),oldScroll:this.oldScroll.x,forward:"right",backward:"left"},vertical:{newScroll:this.adapter.scrollTop(),oldScroll:this.oldScroll.y,forward:"down",backward:"up"}};for(var t in i){var o=i[t],s=o.newScroll>o.oldScroll?o.forward:o.backward;for(var n in this.waypoints[t]){var r=this.waypoints[t][n];if(null!==r.triggerPoint){var l=o.oldScroll<r.triggerPoint,a=o.newScroll>=r.triggerPoint;(l&&a||!l&&!a)&&(r.queueTrigger(s),e[r.group.id]=r.group)}}}for(var d in e)e[d].flushTriggers();this.oldScroll={x:i.horizontal.newScroll,y:i.vertical.newScroll}},n.prototype.innerHeight=function(){return this.element==this.element.window?o.viewportHeight():this.adapter.innerHeight()},n.prototype.remove=function(e){delete this.waypoints[e.axis][e.key],this.checkEmpty()},n.prototype.innerWidth=function(){return this.element==this.element.window?o.viewportWidth():this.adapter.innerWidth()},n.prototype.destroy=function(){var e=[];for(var i in this.waypoints)for(var t in this.waypoints[i])e.push(this.waypoints[i][t]);for(var o=0,s=e.length;o<s;o++)e[o].destroy()},n.prototype.refresh=function(){var e,i=this.element==this.element.window,t=i?void 0:this.adapter.offset(),s={};for(var n in this.handleScroll(),e={horizontal:{contextOffset:i?0:t.left,contextScroll:i?0:this.oldScroll.x,contextDimension:this.innerWidth(),oldScroll:this.oldScroll.x,forward:"right",backward:"left",offsetProp:"left"},vertical:{contextOffset:i?0:t.top,contextScroll:i?0:this.oldScroll.y,contextDimension:this.innerHeight(),oldScroll:this.oldScroll.y,forward:"down",backward:"up",offsetProp:"top"}}){var r=e[n];for(var l in this.waypoints[n]){var a,d,c,p,u=this.waypoints[n][l],h=u.options.offset,f=u.triggerPoint,v=0,w=null==f;u.element!==u.element.window&&(v=u.adapter.offset()[r.offsetProp]),"function"==typeof h?h=h.apply(u):"string"==typeof h&&(h=parseFloat(h),u.options.offset.indexOf("%")>-1&&(h=Math.ceil(r.contextDimension*h/100))),a=r.contextScroll-r.contextOffset,u.triggerPoint=Math.floor(v+a-h),d=f<r.oldScroll,c=u.triggerPoint>=r.oldScroll,p=!d&&!c,!w&&(d&&c)?(u.queueTrigger(r.backward),s[u.group.id]=u.group):(!w&&p||w&&r.oldScroll>=u.triggerPoint)&&(u.queueTrigger(r.forward),s[u.group.id]=u.group)}}return o.requestAnimationFrame((function(){for(var e in s)s[e].flushTriggers()})),this},n.findOrCreateByElement=function(e){return n.findByElement(e)||new n(e)},n.refreshAll=function(){for(var e in t)t[e].refresh()},n.findByElement=function(e){return t[e.waypointContextKey]},window.onload=function(){s&&s(),n.refreshAll()},o.requestAnimationFrame=function(i){(window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||e).call(window,i)},o.Context=n}(),function(){function e(e,i){return e.triggerPoint-i.triggerPoint}function i(e,i){return i.triggerPoint-e.triggerPoint}var t={vertical:{},horizontal:{}},o=window.Waypoint;function s(e){this.name=e.name,this.axis=e.axis,this.id=this.name+"-"+this.axis,this.waypoints=[],this.clearTriggerQueues(),t[this.axis][this.name]=this}s.prototype.add=function(e){this.waypoints.push(e)},s.prototype.clearTriggerQueues=function(){this.triggerQueues={up:[],down:[],left:[],right:[]}},s.prototype.flushTriggers=function(){for(var t in this.triggerQueues){var o=this.triggerQueues[t],s="up"===t||"left"===t;o.sort(s?i:e);for(var n=0,r=o.length;n<r;n+=1){var l=o[n];(l.options.continuous||n===o.length-1)&&l.trigger([t])}}this.clearTriggerQueues()},s.prototype.next=function(i){this.waypoints.sort(e);var t=o.Adapter.inArray(i,this.waypoints);return t===this.waypoints.length-1?null:this.waypoints[t+1]},s.prototype.previous=function(i){this.waypoints.sort(e);var t=o.Adapter.inArray(i,this.waypoints);return t?this.waypoints[t-1]:null},s.prototype.queueTrigger=function(e,i){this.triggerQueues[i].push(e)},s.prototype.remove=function(e){var i=o.Adapter.inArray(e,this.waypoints);i>-1&&this.waypoints.splice(i,1)},s.prototype.first=function(){return this.waypoints[0]},s.prototype.last=function(){return this.waypoints[this.waypoints.length-1]},s.findOrCreate=function(e){return t[e.axis][e.name]||new s(e)},o.Group=s}(),function(){var e=window.jQuery,i=window.Waypoint;function t(i){this.$element=e(i)}e.each(["innerHeight","innerWidth","off","offset","on","outerHeight","outerWidth","scrollLeft","scrollTop"],(function(e,i){t.prototype[i]=function(){var e=Array.prototype.slice.call(arguments);return this.$element[i].apply(this.$element,e)}})),e.each(["extend","inArray","isEmptyObject"],(function(i,o){t[o]=e[o]})),i.adapters.push({name:"jquery",Adapter:t}),i.Adapter=t}(),function(){var e=window.Waypoint;function i(i){return function(){var t=[],o=arguments[0];return i.isFunction(arguments[0])&&((o=i.extend({},arguments[1])).handler=arguments[0]),this.each((function(){var s=i.extend({},o,{element:this});"string"==typeof s.context&&(s.context=i(this).closest(s.context)[0]),t.push(new e(s))})),t}}window.jQuery&&(window.jQuery.fn.waypoint=i(window.jQuery)),window.Zepto&&(window.Zepto.fn.waypoint=i(window.Zepto))}(),function(e){e(document).ready((function(){!function(){var i=e("#megaNav"),t=e("#toggle-megaNav"),o=e("#megaNav__close"),s=window.matchMedia("(min-width: 70rem)");function n(){s.matches?(i.addClass("is-largescreen"),i.removeClass("is-smallscreen"),e("#megaNav.is-largescreen, .megaNav__topLevel-item.has-children, .megaNav__secondLevel-item.has-children, #megaNav.is-smallscreen .has-children > a").unbind(),e("#megaNav.is-largescreen").hoverIntent({over:function(){var i=e(this);r(i),r(e(".megaNav__secondLevel-item.has-children",i).eq(0))},out:function(){e(this).closest(".is-expanded").removeClass("is-expanded")},selector:".megaNav__topLevel-item.has-children",sensitivity:25,timeout:200}),e("#megaNav.is-largescreen").hoverIntent({over:function(){var i=e(this);r(i),r(e(".megaNav__thirdLevel-item.has-children",i).eq(0))},out:function(){},selector:".megaNav__secondLevel-item.has-children",sensitivity:75}),e("#megaNav.is-largescreen").hoverIntent({over:function(){e("body").addClass("has-expanded-nav")},out:function(){e(".is-expanded",i).removeClass("is-expanded"),e("body").removeClass("has-expanded-nav")},timeout:200}),e(".has-expanded-nav").on("click",(function(){e(".is-expanded",i).removeClass("is-expanded"),e("body").removeClass("has-expanded-nav")}))):(e("body, #megaNav.is-largescreen, .megaNav__topLevel-item.has-children, .megaNav__secondLevel-item.has-children, #megaNav.is-smallscreen .has-children > a").unbind(),i.removeClass("is-largescreen"),i.addClass("is-smallscreen"),e(document).on("click","#megaNav.is-smallscreen .has-children > a",(function(i){i.preventDefault(),r(e(this).parent())})),e(".megaNav__closeLevel",i).on("click",(function(i){i.preventDefault(),e(this).closest(".is-expanded").removeClass("is-expanded"),e(".megaNav__topLevel").scrollTop(0)})))}function r(i){var t=i.siblings();e(".is-expanded",t).removeClass("is-expanded"),e(t).removeClass("is-expanded"),e(".megaNav__topLevel").scrollTop(0),e(i).addClass("is-expanded")}t.on("click",(function(){i.hasClass("is-open")?(e(this).removeClass("is-toggled"),i.removeClass("is-open"),e("body").removeClass("has-expanded-smallscreen-nav")):(e(this).addClass("is-toggled"),i.addClass("is-open"),e("body").addClass("has-expanded-smallscreen-nav"))})),o.on("click",(function(){t.removeClass("is-toggled"),i.removeClass("is-open"),e("body").removeClass("has-expanded-smallscreen-nav")})),n(),e(window).smartResize((function(){s=window.matchMedia("(min-width: 70rem)"),n()}))}(),e(".js-tabs").each((function(){var i=e(this),t=e(".tabs__link",i),o=e(".tabs__section",i),s=e(".tabs__link.is-selected",i).attr("href");o.hide(),s?e(s).show():(e(t[0]).addClass("is-selected"),e(o[0]).show().addClass("is-expanded")),t.on("click",(function(i){i.preventDefault();var s=e(this).attr("href");o.hide().removeClass("is-expanded"),e(s).show().addClass("is-expanded"),t.removeClass("is-selected"),e(this).addClass("is-selected"),e(".js-slider--variable").slick("setPosition",0)}))})),e(".js-slider--tiles").slick({slidesToShow:3.1,slidesToScroll:3,infinite:!1,swipeToSlide:!0,responsive:[{breakpoint:1e3,settings:{slidesToShow:2.1,slidesToScroll:2}},{breakpoint:700,settings:{slidesToShow:1,slidesToScroll:1,centerMode:!0,centerPadding:"5%"}}]}),e(".js-slider--event-cards").slick({slidesToShow:3.1,slidesToScroll:3,infinite:!1,swipeToSlide:!0,responsive:[{breakpoint:1e3,settings:{slidesToShow:2.5,slidesToScroll:2}},{breakpoint:600,settings:{slidesToShow:1.25,slidesToScroll:1}},{breakpoint:360,settings:{slidesToShow:1.1,slidesToScroll:1}}]}),e(".js-slider--accolades").slick({slidesToShow:5,slidesToScroll:5,infinite:!1,swipeToSlide:!0,responsive:[{breakpoint:900,settings:{slidesToShow:3.25,slidesToScroll:3}},{breakpoint:500,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:360,settings:{slidesToShow:1,slidesToScroll:1,centerMode:!0,centerPadding:"5%"}}]}),e(".js-slider--variable").each((function(){e(this).slick({slidesToShow:1,slidesToScroll:1,infinite:!1,centerMode:!0,centerPadding:"10%",adaptiveHeight:!0,variableWidth:!0,swipeToSlide:!0,responsive:[{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:1}}]})})),e(".js-slider--gallery").each((function(){e(this).slick({slidesToShow:1,slidesToScroll:1,infinite:!1,adaptiveHeight:!0,asNavFor:".js-slider--gallery__nav",waitForAnimate:!1})})),e(".js-slider--gallery__nav").each((function(){e(this).slick({slidesToShow:6.5,infinite:!1,asNavFor:".js-slider--gallery",centerMode:!1,varableWidth:!0,focusOnSelect:!0,waitForAnimate:!1,swipeToSlide:!0,arrows:!1})})),e(".js-waypoint").each((function(){var i=e(this);i.waypoint((function(e){"down"===e?i.addClass("is-waypoint-reached"):i.removeClass("is-waypoint-reached")}),{offset:Waypoint.viewportHeight()-window.innerHeight/50})})),function(){function i(i){return e('.js-page-nav .page-nav__link[href="#'+i+'"]')}function t(i){var t,o=e(".page-nav__list")[0];if((t=o).scrollWidth>t.offsetWidth){var s=e(".page-nav__inner")[0],n=i.position().left-e(s).width()/2+e(i).width()/2;e(s).stop().animate({scrollLeft:n},250)}}e(".js-waypoint-page-section").each((function(){var o=e(this);o.waypoint((function(e){var s=i(o.attr("id"));s.toggleClass("is-active","down"===e),s.hasClass("is-active")&&t(s)}),{offset:window.innerHeight/5}),o.waypoint((function(e){var s=i(o.attr("id"));s.toggleClass("is-active","up"===e),s.hasClass("is-active")&&t(s)}),{offset:function(){return-e(o).height()+window.innerHeight/5}})})),e(".page-nav__link").on("click",(function(){var i=e(e(this).attr("href"));e("html, body").stop().animate({scrollTop:i.offset().top-window.innerHeight/10},250)}))}()}))}(jQuery);
